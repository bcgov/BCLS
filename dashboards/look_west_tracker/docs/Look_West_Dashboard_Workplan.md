...
- **Dashboard prototype built.** An **HTML-based** Look West Monitor and five tracker subpages exist (`dashboards/look_west_tracker/`). HTML was chosen over Power BI for flexibility in design, navigation, interactivity, and UX.
